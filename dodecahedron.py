...
# Definir Vertices
P1 = gf.Vertex(0, -r, 0.01)
P6 = gf.Vertex(0, r, h1 + h2)
P2 = gf.Vertex(r * cos18, -r * sin18, 0.01)
P7 = gf.Vertex(-P2.x, -P2.y, P6.z)
P3 = gf.Vertex(r * cos54, r * sin54, 0.01)
P8 = gf.Vertex(-P3.x, -P3.y, P6.z)
P4 = gf.Vertex(-P3.x, P3.y, 0.01)
P9 = gf.Vertex(-P4.x, -P4.y, P6.z)
P5 = gf.Vertex(-P2.x, P2.y, 0.01)
P10 = gf.Vertex(P2.x, -P2.y, P6.z)
P11 = gf.Vertex(0, -rr, h1)
P12 = gf.Vertex(P1.x, -P11.y, h2)
P13 = gf.Vertex(rr * cos54, -rr * sin54, h2)
P14 = gf.Vertex(-P13.x, -P13.y, h1)
P15 = gf.Vertex(rr * cos18, -rr * sin18, h1)
P16 = gf.Vertex(-P15.x, -P15.y, h2)
P17 = gf.Vertex(P15.x, -P15.y, h2)
P18 = gf.Vertex(-P17.x, -P17.y, h1)
P19 = gf.Vertex(P10.x, -P13.y, h1)
P20 = gf.Vertex(-P19.x, -P19.y, h2)
