...
instances = [gf.Instance(dodecahedron, gf.Vertex(8, 0, 20), gf.MakeOYRotationMatrix(200), 0.75),
             gf.Instance(dodecahedron, gf.Vertex(3, 5, 30), gf.MakeOYRotationMatrix(200), 0.75)]
...
lights = [
    gf.Light("ambient",0.1),
    gf.Light("point", 0.6, (2, 1, 0)),
    gf.Light("directional", 0.3, (1, 4, 4))]
